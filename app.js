...
// const plusButtons=document.querySelectorAll('#heartCount1');
// const minusButtons=document.querySelectorAll('#heartCount2');
// const quantitySpans=document.querySelectorAll('#itemcount');

// function updateTotalPrice(){
//     const totalPriceElement=document.getElementById('total');
//     let totalPrice=0;
//     quantitySpans.forEach((span,index)=>
//         {const price=parseFloat(span.parentNode.parentNode.querySelector('p').innerText.replace('$',''));
//      totalprice +=price*parseInt(span.innerText);
//         });
